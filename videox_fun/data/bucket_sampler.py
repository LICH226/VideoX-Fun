...
class AspectRatioBatchImageVideoSamplerTryOn(BatchSampler):
    def __init__(self, sampler, dataset, batch_size, aspect_ratios=ASPECT_RATIO_512, drop_last=False):
        self.sampler = sampler
        self.dataset_meta = dataset.dataset if hasattr(dataset, 'dataset') else dataset
        self.batch_size = batch_size
        self.aspect_ratios = aspect_ratios
        self.drop_last = drop_last
